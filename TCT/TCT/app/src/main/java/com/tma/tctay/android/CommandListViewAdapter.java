...
public class CommandListViewAdapter extends ArrayAdapter<ListViewCommandItemModel>{
    ...
    public CommandListViewAdapter(Context context, ArrayList<ListViewCommandItemModel> modelsArrayList, AccessToken accessToken)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(!modelsArrayList.get(position).isHeader()){
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    if (NetworkUtility.isNetworkAvailable(getContext())) {
                        if (b) {
                            ...
                            new SendCommandToDeviceTask(accessToken, b, getContext()).execute();
                        } else {
            ...
            TextView titleView = (TextView) rowView.findViewById(R.id.headerTextView);
            titleView.setText(modelsArrayList.get(position).getTitle());
